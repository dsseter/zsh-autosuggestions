# Detect deprecated config variables and autosuggest-start widget

unset _ZSH_AUTOSUGGEST_DEPRECATED_START_WIDGET_WARNING_SHOWN

_zsh_autosuggest_check_deprecated_config() {
	if [ -n "$AUTOSUGGESTION_HIGHLIGHT_COLOR" ]; then
		_zsh_autosuggest_deprecated_warning "AUTOSUGGESTION_HIGHLIGHT_COLOR is deprecated. Use ZSH_AUTOSUGGEST_HIGHLIGHT_COLOR instead."
		[ -z "$ZSH_AUTOSUGGEST_HIGHLIGHT_COLOR" ] && ZSH_AUTOSUGGEST_HIGHLIGHT_COLOR=$AUTOSUGGESTION_HIGHLIGHT_COLOR
